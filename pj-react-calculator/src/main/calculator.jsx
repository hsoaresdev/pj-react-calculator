...
export default class Calculator extends Component {
    ...
    addDigit(n) {
        if(n === '.' && this.state.displayValue.includes('.')){     // para não colocar mais de um ponto nos numeros
            return
        }

        const clearDisplay = this.state.displayValue === '0'        //não deixa acrescentar 0 a esquerda
